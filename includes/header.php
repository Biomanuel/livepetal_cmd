...
<nav class="navbar navbar-expand-lg fixed-top nav-bg">
    <div>
        <a class="navbar-brand" href="index.php"><img src="assets/img/logo.png" alt="BlinkTrader" /> <span class="logo-text">BlinkTraders</span></a>
    </div>
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    ...
    <ul class="navbar-nav ml-auto">
      <li class="nav-item nav-item-border-b">
        <a class="nav-link <?= $mi1 ?>" href="index.php">
      ...
      <li class="nav-item nav-item-border-b dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
          <a class="dropdown-item" href="#">crypto investment</a>
