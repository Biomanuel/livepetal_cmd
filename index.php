        ...
        <main class="main">
            <section class="hero-banner-head">
                <div class="row hero-banner-cards">
                    <div class="card col col-lg-4 force-bg-black">
                    ...
                    <div class="card col col-lg-4 force-bg-blue">
                      <div class="card-body text-center">
                        ...
                        <p class="card-text force-color-white">This feature allows smooth and easy processing of investment funds into clients' account. Our platform supports multiple media for investment funding.</p>
                      </div>
                    </div>
                    <div class="card col col-lg-4 force-bg-white">
                      <div class="card-body text-center">
            ...
            <section class="about-section">
                <div class="row about-section-content">
                    <div class="col col-lg-6">
                        <img src="assets/img/intro1.png" class="about-section-content-img" />
                    </div>
                    <div class="col col-lg-6 about-section-content-mc">
            ...
            <section class="pricing-div">
                <div class="row about-section-content">
                    <div class="col col-lg-3">
                        <div class="card force-bg-white px-5">
                          <div class="card-body text-center">
                    ...
                    <div class="col col-lg-3">
                        <div class="card force-bg-black px-5">
                          <div class="card-body text-center">
            ...
            <section class="mt-5 mb-5">
                ...
                <div class="row about-section-content">
                    <div class="col col-lg-4">
                        <div class="card px-2">
                          <img class="card-img-top" src="assets/img/services1.png" alt="Card image cap">
                          <div class="card-body">
