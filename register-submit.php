...
<path d="M22.28 21.096V24H12.536V21.096H15.944V13.824C15.752 14.064 15.424 14.32 14.96 14.592C14.512 14.864 14.016 15.096 13.472 15.288C12.944 15.48 12.472 15.576 12.056 15.576V12.576C12.344 12.576 12.688 12.488 13.088 12.312C13.504 12.12 13.912 11.896 14.312 11.64C14.728 11.384 15.08 11.136 15.368 10.896C15.672 10.64 15.864 10.44 15.944 10.296H19.232V21.096H22.28Z" fill="white"/>
                                    ...
                                    <div class="px-2">
                                        <form action="<?= $_SERVER['PHP_SELF']; ?>" method="post">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control input-outline" name="referral_id" value="<?= $referral_id ?>" >
                                                <span class="force-color-red"><?= $referral_id_err ?></span>
                                            </div>
                                            <div class="form-group">
                                                <label class="force-color-black">Country <span class="force-color-blue">*</span></label>
                                                <input type="text" class="form-control input-outline" name="country" value="<?= $country ?>">
                                                <span class="force-color-red"><?= $country_err ?></span>
                                            </div>
                                            <div class="form-group">
                                                <label class="force-color-black">Create Password <span class="force-color-blue">*</span></label>
                                                <input type="password" class="form-control input-outline" name="password" value="<?= $password ?>">
                                                <span class="force-color-red"><?= $password_err ?></span>
                                            </div>
                                            <div class="form-group">
                                                <label class="force-color-black">Confirm Password <span class="force-color-blue">*</span></label>
                                                <input type="password" class="form-control input-outline" name="re_password" value="<?= $re_password ?>">
                                                <span class="force-color-red"><?= $re_password_err ?></span>
                                            </div>
                                            <div class="cover">
        ...
        <script>
            ...
            if(msg === "sucess"){
                ...
                window.location.href = "register.php?msg=invalid";
            }
            <?php } ?>
            <?php if($message_err != ""){ ?>
            window.onload = (event) => {
