<?php    
    ...
    $mi2_s = $mi3_s = $mi4_s = $mi5_s = $mi6_s = $mi7_s = $mi8_s = "";
    $mi2_l1 = $mi2_l2 = $mi3_l1 = $mi3_l2 = $mi4_l1 = $mi4_l2 = $mi4_l3 = $mi4_l4 = $mi4_l5 = $mi5_l1 = $mi5_l2 = $mi5_l3 = $mi5_l4 = $mi8_l1 = $mi8_l2 = $mi8_l3 = "";
...
<div class="sidebar-div-adm">
    ...
    <div class="sidebar-link-div-adm">
        <div>
            <a href="index.php" class="py-2 px-2 link-adm <?= $mi1 ?>">
        ...
        <div class="dropdown-adm <?= $mi2_s ?>">
            ...
            <div class="dropdown-menu admin-drop-menu <?= $mi2_s ?>" aria-labelledby="navbarDropdownMenuLink">
              <a class="force-color-white ml-4 py-1 px-2 small-font-size <?= $mi2_l1 ?>" href="user-management-client-account.php">
                  <i class="far fa-user mr-2"></i>
                  Clients Account
                </a><br>
              <a class="force-color-white ml-4 py-1 px-2 small-font-size <?= $mi2_l2 ?>" href="user-management-promotional.php">
        ...
        <div class="dropdown-adm <?= $mi3_s ?>">
            ...
            <div class="dropdown-menu admin-drop-menu <?= $mi3_s ?>" aria-labelledby="navbarDropdownMenuLink">
              <a class="force-color-white ml-4 py-1 px-2 small-font-size <?= $mi3_l1 ?>" href="system-config-settings.php">
                  <i class="fas fa-cog mr-2"></i>
                  Settings
                </a><br>
              <a class="force-color-white ml-4 py-1 px-2 small-font-size <?= $mi3_l2 ?>" href="system-config-account-info.php">
        ...
        <div class="dropdown-adm <?= $mi4_s ?>">
            ...
            <div class="dropdown-menu admin-drop-menu <?= $mi4_s ?>" aria-labelledby="navbarDropdownMenuLink">
              <a class="force-color-white ml-4 py-1 px-2 small-font-size <?= $mi4_l1 ?>" href="deposit-paymentgate.php">
                  <i class="far fa-user mr-2"></i>
                  Payment gateways
                </a><br>
              <a class="force-color-white ml-4 py-1 px-2 small-font-size <?= $mi4_l2 ?>" href="deposit-log.php">
        ...
        <div class="dropdown-adm <?= $mi5_s ?>">
            ...
            <div class="dropdown-menu admin-drop-menu <?= $mi5_s ?>" aria-labelledby="navbarDropdownMenuLink">
              <a class="force-color-white ml-4 py-1 px-2 small-font-size <?= $mi5_l1 ?>" href="withdraw-log.php">
                  <i class="fas fa-cog mr-2"></i>
                  Withdraw log
                </a><br>
        ...
        <div>
            <a href="masterclass.php" class="py-2 px-2 link-adm <?= $mi6 ?>">
                <span class="force-color-white mr-2"><i class="fas fa-home"></i></span>
                <span class="force-color-white">Masterclass</span>
            </a>
        </div>
        <div>
            <a href="copytrade.php" class="py-2 px-2 link-adm <?= $mi7 ?>">
                <span class="force-color-white mr-2"><i class="fas fa-home"></i></span>
        ...
        <div class="dropdown-adm <?= $mi8_s ?>">
            ...
            <div class="dropdown-menu admin-drop-menu <?= $mi8_s ?>" aria-labelledby="navbarDropdownMenuLink">
              <a class="force-color-white ml-4 py-1 px-2 small-font-size <?= $mi8_l1 ?>" href="blog-post-new.php">
                  <i class="fas fa-pencil-alt mr-2"></i>
                    New post
                </a><br>
                <a class="force-color-white ml-4 py-1 px-2 small-font-size <?= $mi8_l2 ?>" href="blog-article.php">
                  <i class="far fa-newspaper mr-2"></i>
                    Articles
                </a><br>
                <a class="force-color-white ml-4 py-1 px-2 small-font-size <?= $mi8_l3 ?>" href="blog-category.php">
