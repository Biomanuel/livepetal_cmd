    ...
    <body>
        <main class="main-dash row">
            ...
            <section class="heading-dash col col-lg-11">
                ...
                <div class="mt-5 ml-5">
                    <h4 class="force-color-black">BLINK TRADERS MASTERCLASS AGREEMENT</h4>
                    <div class="mt-5 mb-5 px-5">
                       <div class="card border border-primary">
                          <div class="card-body">
                              <div class="dotted-line-masterclass text-center">
                                    <h5 class="force-color-black">Mentorship Agreement on Trading</h5>
                              </div>
                              <div>
                                  ...
                                  <p>
                                    <span class="mr-5 small-font-size">Name: Blink Traders</span>
                                      <span class="small-font-size ml-5">mentor</span><br>
                                      <span class="small-font-size">Email Address: support@blinktraders.com</span>
                                  </p>
                                  <ol>
...
(Copies of the agreement to be signed and given to each participating party.)
                        ...
                        <div class="small-font-size border-name-bottom">
                            <span class="mr-2">Kehinde Jacob Metibemu</span>
                          </div>
                        <br>
                        ...
                        <div class="d-flex justify-content-center">
                            <button type="button" class="btn btn-primary px-5">I AGREE</button>
                        </div>
